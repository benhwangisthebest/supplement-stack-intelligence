...
//   --scenario S     S1 | S2 | S3 | S4 | S5, stamped on every call-log line
...
export const SCENARIOS = Object.freeze(["S1", "S2", "S3", "S4", "S5"]); // S4: U4 ruling R7 (2026-09-23); S5: U4 ruling R16 (2026-09-24)
