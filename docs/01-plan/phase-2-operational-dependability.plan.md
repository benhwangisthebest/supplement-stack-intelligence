...
**DONE 2026-08-10** (+19 unit tests → **1131/91**; +5 ungated E2E, executed locally against a production
build). Baseline before the unit: 1112/90, typecheck clean. Shipped **five** headers, each justified
