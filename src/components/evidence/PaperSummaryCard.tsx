  ...
  return (
    <article className="rounded-lg border border-neutral-200 p-4">
      <div className="flex items-start justify-between gap-3">
        ...
        <span className="shrink-0 rounded-full bg-neutral-100 px-2 py-0.5 text-[11px] font-medium uppercase tracking-wide text-neutral-600">
          {paper.studyType}
        </span>
      </div>
      ...
      <dl className="mt-3 grid grid-cols-1 gap-2 text-xs sm:grid-cols-2">
        <div>
          ...
          <dd className="text-neutral-600">{paper.dose}</dd>
        </div>
        <div>
          <dt className="font-medium text-neutral-700">Duration</dt>
          <dd className="text-neutral-600">{paper.duration}</dd>
        </div>
      </dl>

      <p className="mt-3 text-sm text-neutral-700">{paper.summary}</p>
