...
export interface ProtocolSuggestion {
  ...
  feedback?: number; // daily-checkin v10 — bounded, evidence-subordinate check-in nudge (below grade)
  feedbackNote?: string | null; // daily-checkin v10 — "adjusted by your check-ins" note
