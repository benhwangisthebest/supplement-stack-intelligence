...
// require the live advisor (configured Supabase + OPENAI_BASE_URL/_API_KEY + migration
// 0004 applied). Gated on E2E_LIVE, same posture as the v6 advisor L3 flow.

test.describe("[LIVE] L2/L3: suggest-then-confirm UI", () => {
  test.skip(!LIVE, "requires live Supabase + OPENAI_BASE_URL/_API_KEY + migration 0004 (set E2E_LIVE=1)");
