...
// confirm card require the live advisor (configured Supabase + OPENAI_BASE_URL/_API_KEY +
...
test.describe("[LIVE] L2: live streaming + multi-action confirm", () => {
  test.skip(!LIVE, "requires live Supabase + OPENAI_BASE_URL/_API_KEY + migration 0005 (set E2E_LIVE=1)");
