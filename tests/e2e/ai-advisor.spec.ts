...
// (a configured Supabase project + OPENAI_BASE_URL/OPENAI_API_KEY + migration 0003 applied).
...
test.describe("[LIVE] L3: authed grounded chat", () => {
  test.skip(!LIVE, "requires live Supabase + OPENAI_BASE_URL/_API_KEY (set E2E_LIVE=1)");
